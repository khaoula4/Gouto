...
public class TopSheetDialog extends AppCompatDialog {
    ...
    private com.example.gouto.TopSheetBehavior<FrameLayout> topSheetBehavior;
    ...
    private View wrapInTopSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ...
        topSheetBehavior = com.example.gouto.TopSheetBehavior.from(topSheet);
    ...
    private com.example.gouto.TopSheetBehavior.TopSheetCallback mTopSheetCallback
            = new com.example.gouto.TopSheetBehavior.TopSheetCallback() {
        @Override
        public void onStateChanged(@NonNull View topSheet,
                                   @BottomSheetBehavior.State int newState) {
            if (newState == com.example.gouto.TopSheetBehavior.STATE_HIDDEN) {
                dismiss();
            }
        }
